...
export default function Header() {
  ...
  const responseMenuItems = [
    ...
    { to: "/admin/customer-accesses", label: "顧客マイページ管理", icon: <PeopleIcon fontSize="small" /> },
  ...
  const getAdminMenuItems = () => {
    const items = [
      ...
      { to: "/admin/line-config", label: "LINE設定", icon: <ChatIcon fontSize="small" />, minRole: 'admin' },
      { to: "/admin/line-templates", label: "LINEテンプレート", icon: <ChatIcon fontSize="small" />, minRole: 'admin' },
