...
Rails.application.configure do
  # Prepare the ingress controller used to receive mail (SendGrid Inbound Parse)
  ...
  config.logger = ActiveSupport::TaggedLogging.logger(Rails.root.join("log/production.log"))
  ...
  config.action_mailer.default_url_options = { host: "cocosumo.space" }

  # Outgoing SMTP via SendGrid
